...
{
    /// <summary>
    ///     The Editor for a <see cref="RuleTile" />. Mirrors Unity's RuleTileEditor but targets our
    ///     <see cref="RuleTile" /> (which inherits from <see cref="Tile" />), so the "default" sprite / gameObject /
    ///     collider fields are read straight off the inherited <see cref="Tile" /> properties.
    /// </summary>
    ...
    public class RuleTileEditor : Editor
    {
        ...
        /// <summary>Default height for a Rule Element</summary>
        public const float k_DefaultElementHeight = 48f;

        /// <summary>Padding between Rule Elements</summary>
        public const float k_PaddingBetweenRules = 8f;

        /// <summary>Single line height</summary>
        public const float k_SingleLineHeight = 18f;

        /// <summary>Width for labels</summary>
        ...
        /// <summary>Whether the RuleTile can extend its neighbors beyond directly adjacent ones</summary>
        public bool extendNeighbor;

        /// <summary>Grid for rendering previews</summary>
        public Grid m_PreviewGrid;

        /// <summary>List of Tilemaps for rendering previews</summary>
        public List<Tilemap> m_PreviewTilemaps;

        /// <summary>List of TilemapRenderers for rendering previews</summary>
        public List<TilemapRenderer> m_PreviewTilemapRenderers;

        /// <summary>List of Sprites for Drag and Drop</summary>
        private List<Sprite> dragAndDropSprites;

        private MethodInfo m_ClearCacheMethod;

        /// <summary>Preview Utility for rendering previews</summary>
        ...
        /// <summary>Array of arrow textures used for marking positions for Rule matches</summary>
        ...
        /// <summary>Arrays of textures used for marking transform Rule matches</summary>
        ...
        /// <summary>The RuleTile being edited</summary>
        ...
        /// <summary>OnEnable for the RuleTileEditor</summary>
        ...
        /// <summary>OnDisable for the RuleTileEditor</summary>
        ...
        /// <summary>Get the GUI bounds for a Rule.</summary>
        ...
        /// <summary>Callback when the Rule list is updated</summary>
        ...
        /// <summary>Gets the GUI element height for a TilingRule</summary>
        ...
        /// <summary>Gets the GUI element height for a TilingRuleOutput</summary>
        ...
        /// <summary>Gets the GUI matrix size for a Rule of a RuleTile</summary>
        ...
        /// <summary>Draws the Rule element for the Rule list</summary>
        ...
        private void OnAddElement(object obj)
        {
            ...
            rule.m_Sprites[0] = tile.sprite;
            rule.m_GameObject = tile.gameObject;
            rule.m_ColliderType = tile.colliderType;
        ...
        /// <summary>Saves any changes to the RuleTile</summary>
        ...
        /// <summary>Draws the header for the Rule list</summary>
        ...
        /// <summary>Draws the Inspector GUI for the RuleTileEditor</summary>
        public override void OnInspectorGUI()
        {
            ...
            tile.sprite =
                EditorGUILayout.ObjectField(Styles.defaultSprite, tile.sprite, typeof(Sprite), false) as Sprite;
            tile.gameObject =
                EditorGUILayout.ObjectField(Styles.defaultGameObject, tile.gameObject, typeof(GameObject), false)
                    as GameObject;
            tile.colliderType =
                (Tile.ColliderType)EditorGUILayout.EnumPopup(Styles.defaultCollider, tile.colliderType);
        ...
        /// <summary>Draw editor fields for custom properties for the RuleTile</summary>
        ...
        /// <summary>Gets the index for a Rule with the RuleTile to display an arrow.</summary>
        ...
        /// <summary>Draws a neighbor matching rule</summary>
        ...
        /// <summary>Draws a tooltip for the neighbor matching rule</summary>
        ...
        /// <summary>Draws a transform matching rule</summary>
        ...
        /// <summary>Handles a neighbor matching Rule update from user mouse input</summary>
        public void RuleNeighborUpdate(Rect rect, RuleTile.TilingRule tilingRule,
            Dictionary<Vector3Int, int> neighbors, Vector3Int position)
        {
        ...
        /// <summary>Handles a transform matching Rule update from user mouse input</summary>
        ...
        /// <summary>Determines whether the current mouse position is within the given Rect.</summary>
        public virtual bool ContainsMousePosition(Rect rect)
        {
            return rect.Contains(Event.current.mousePosition);
        }

        /// <summary>Gets the offset change for a mouse click input</summary>
        public static int GetMouseChange()
        {
            return Event.current.button == 1 ? -1 : 1;
        }

        /// <summary>Draws a Rule Matrix for the given Rule for a RuleTile.</summary>
        ...
        /// <summary>Draws a Rule Matrix Icon for the given matching Rule for a RuleTile with the given position</summary>
        ...
        /// <summary>Draws a Sprite field for the Rule</summary>
        ...
        /// <summary>Draws an Inspector for the Rule</summary>
        public void RuleInspectorOnGUI(Rect rect, RuleTile.TilingRuleOutput tilingRule)
        {
            ...
            if (tilingRule.m_Output != RuleTile.TilingRuleOutput.OutputSprite.Single)
            {
                GUI.Label(new Rect(rect.xMin, y, k_LabelWidth, k_SingleLineHeight),
                    tilingRule.m_Output == RuleTile.TilingRuleOutput.OutputSprite.Animation
                        ? Styles.tilingRulesAnimationSize
                        : Styles.tilingRulesRandomSize);
                EditorGUI.BeginChangeCheck();
        ...
        /// <summary>Whether the RuleTile has a preview GUI</summary>
        public override bool HasPreviewGUI()
        {
            return true;
        }

        /// <summary>Draws the preview GUI for the RuleTile</summary>
        ...
        /// <summary>Creates a Preview for the RuleTile.</summary>
        ...
        /// <summary>Handles cleanup for the Preview GUI</summary>
        ...
        /// <summary>Renders a static preview Texture2D for a RuleTile asset</summary>
                ...
                if (t != null)
                {
                    ...
                    if (method != null)
                    {
                        var ret = method.Invoke("RenderStaticPreview",
                            new object[] { tile.sprite, Color.white, width, height });
                        if (ret is Texture2D)
        ...
        /// <summary>Converts a Base64 string to a Texture2D</summary>
        ...
        /// <summary>Copies all Rules from a RuleTile to the clipboard</summary>
        [MenuItem("CONTEXT/RuleTile/Copy All Rules (MagusStudios)")]
        ...
        /// <summary>Pastes all Rules from the clipboard to a RuleTile</summary>
        [MenuItem("CONTEXT/RuleTile/Paste Rules (MagusStudios)")]
        ...
        private static class Styles
        {
            public static readonly GUIContent defaultSprite = EditorGUIUtility.TrTextContent("Default Sprite"
                , "The default Sprite set when creating a new Rule. Backed by the inherited Tile.sprite field.");

            public static readonly GUIContent defaultGameObject = EditorGUIUtility.TrTextContent("Default GameObject"
                , "The default GameObject set when creating a new Rule. Backed by the inherited Tile.gameObject field.");

            public static readonly GUIContent defaultCollider = EditorGUIUtility.TrTextContent("Default Collider"
                , "The default Collider Type set when creating a new Rule. Backed by the inherited Tile.colliderType field.");
        ...
        /// <summary>Wrapper for serializing a list of Rules</summary>
        [Serializable]
